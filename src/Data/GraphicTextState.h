...
public:
	...
	///
	/// @returns Funkcia vráti typ textu, ktorý udáva, èo je jeho obsahom, napr. XML, C, Java, Lua súbor
	...
	/// Funkcia nám naèíta súbor s gramatikov. Tento súbor musí by uložený na preddefinovanom mieste.
	///
	/// @param filename Udáva názov súboru, ktorý sa ma naèíta. Konèí príponov .lua, ale túto príponu nezadávame
